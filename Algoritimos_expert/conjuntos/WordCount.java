...
/*Problema "word.count" 
 * você deve fazer uma função que recebe um texto.
 * retorna o número de ocorrências de cada palavra no
 * texto, cada ocorrêncua deve ser presentada por um objeto do tipo
 * Rank, com os campos word e count, você deve mostar o resultado em letras minus
 * culas
*/
class Rank {
	public String word;
